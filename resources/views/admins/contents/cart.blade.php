                    ...
                    <form action="">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-append" data-toggle="tooltip" title="Thêm mới khách hàng">
                                        <button class="btn btn-primary box-shadow-customer" type="button" data-toggle="modal" data-target="#add_customer">
                                            <i class="ti-plus"></i>
                                        </button>
                                    </span>
                                    </div>
                            ...
                            <div class="col-md-6 text-right">
                                <button type="button" class="btn btn-primary">Thanh toán & in Hóa đơn</button>
                            </div>
