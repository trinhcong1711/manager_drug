...
@section('page-header')
    ...
    <div class="btn-list">
        ...
        <button type="button" class="btn btn-outline-default" data-toggle="tooltip"
                title="Quay lại trang danh sách phiếu kiểm kho!">
            <a href="/kiem-kho"><i class="icon icon-action-undo mr-2"></i>Quay lại</a>
        </button>

        <button type="button" class="btn btn-outline-success" data-toggle="tooltip" title="Lưu và chỉnh sửa!"><i
                class="ti-save-alt mr-2"></i>Lưu & chỉnh sửa
        </button>
        <button type="button" class="btn btn-outline-success" data-toggle="tooltip"
                ...
                class="ti-save-alt mr-2"></i>Lưu & thoát
        </button>
    </div>
    <!-- PAGE-HEADER END -->
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Thêm phiếu kiểm kho</h3>
                    </div>
                    <div class="card-body">
