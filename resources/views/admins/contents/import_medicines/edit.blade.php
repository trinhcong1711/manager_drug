                                ...
                                <table id="import_datatable" class="table card-table table-vcenter text-nowrap">
                                    ...
                                    @foreach($medicines as $medicine)
                                        ...
                                        <tr class="row-medicine">
                                            ...
                                            <th>
                                                <div class="btn-list">
                                                    <button type="button" class="btn btn-icon remove_medicine btn-red">
                                        ...
                                        @else
                                            <tr class="row-medicine">
                                                <th>{{$medicine->name}}</th>
                                                <th>
                                                    {{number_format($medicine->pivot->amount,0,"",",")}}
                                                </th>
                                                <th>
                                                    {{@\App\Entities\Unit::find($medicine->pivot->unit)->name}}
                                                </th>
                                                <th>
                                                    {{$medicine->pivot->note}}
                                                </th>
                                                <th>
                                                    {{number_format($medicine->pivot->price,0,"",",")}}
                                                </th>
                                                <th>
                                                    Đã kiểm
                                                </th>
